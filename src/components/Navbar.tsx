  ...
  return (
    <header
      ...
      className={[
        ...
        headerIsLight
          ? 'border-b border-[#DDD2C5]/60 bg-[#FFF8F2] py-3 text-[#302D28] shadow-sm'
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          <Link
            ...
            aria-label="Emilia Sandobar — Ir a Inicio"
          >
            <span
              role="img"
              aria-label="Logo Emilia Sandobar"
              className="brand-logo inline-block h-8 aspect-[3/1] sm:h-10"
              style={{
                backgroundColor: headerIsLight ? '#7F203D' : '#FFFFFF',
                WebkitMaskImage: `url(${ASSETS.logoBrandmark})`,
                maskImage: `url(${ASSETS.logoBrandmark})`,
          ...
          <div className="hidden items-center md:flex">
            <button
              ...
              className={[
                ...
                'focus-visible:ring-offset-2',
                headerIsLight
                  ? 'bg-[#7F203D] text-white shadow-sm hover:bg-[#691931] focus-visible:ring-offset-[#FFF8F2]'
                  : 'bg-white text-[#302D28] hover:bg-[#F4EFE8] focus-visible:ring-offset-[#181614]',
              ].join(' ')}
            >
          ...
          <div className="flex items-center lg:hidden">
            <button
              ...
              className={[
                ...
                'focus-visible:ring-offset-2',
                headerIsLight
                  ? 'text-[#302D28] hover:bg-[#F4EFE8] focus-visible:ring-offset-[#FFF8F2]'
                  : 'text-white hover:bg-white/10 focus-visible:ring-offset-[#181614]',
              ].join(' ')}
            >
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="mt-4 border-t border-[#DDD2C5]/60 pt-4">
              <button
                id="mobile-cta-consult-btn"
                type="button"
                onClick={handleConsultationClick}
                className="flex w-full cursor-pointer items-center justify-center gap-2 bg-[#7F203D] px-8 py-3.5 text-xs font-bold uppercase tracking-widest text-white shadow-sm transition-colors hover:bg-[#691931] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7F203D] focus-visible:ring-offset-2 focus-visible:ring-offset-[#FFF8F2]"
              >
