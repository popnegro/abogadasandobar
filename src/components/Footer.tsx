    ...
    >
      <div className="mx-auto max-w-7xl px-4 pt-16 pb-12 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-10 border-b border-[#FFF8F2]/10 pb-14 md:grid-cols-2 lg:grid-cols-12 lg:gap-12">
          ...
          {/* Columna 1 — Jurisdicción & Cobertura */}
          <div className="space-y-5 lg:col-span-4">
            ...
            <p
              className="text-sm font-light leading-relaxed text-[#F4EFE8]/75"
            ...
            <div className="space-y-2.5 border-t border-[#FFF8F2]/10 pt-3 text-sm text-[#DDD2C5]">
              <div className="flex items-center gap-2.5">
                <Scale
                  className="h-4 w-4 shrink-0 text-[#7F203D]"
                  aria-hidden="true"
                />
            ...
            <Link
              to={TAB_TO_PATH.experiencia}
              onClick={handleInternalNavigation}
              className={`inline-flex pt-1 text-xs font-semibold uppercase tracking-wider text-[#D9A9B8] transition-colors hover:text-white ${focusRing}`}
            >
              Conocer experiencia →
            </Link>
          </div>

          {/* Columna 2 — Cobertura territorial */}
          <div className="space-y-4 lg:col-span-5">
            ...
            <div className="space-y-4 text-sm text-[#F4EFE8]/85">
              ...
              <div className="space-y-1">
                <span className="block text-xs font-bold uppercase tracking-wider text-[#DDD2C5]">
                  1ª Circunscripción (Gran Mendoza)
                </span>
              ...
              <div className="space-y-1">
                <span className="block text-xs font-bold uppercase tracking-wider text-[#DDD2C5]">
                  2ª &amp; 3ª Circunscripción
                </span>

                <p className="text-sm font-light leading-relaxed text-[#F4EFE8]/70">
                  San Rafael, Gral. Alvear, Malargüe, San Martín, Rivadavia,
                  Junín, Santa Rosa y La Paz.
                </p>
              </div>

              <div className="space-y-1">
                <span className="block text-xs font-bold uppercase tracking-wider text-[#DDD2C5]">
                  4ª Circunscripción (Valle de Uco)
                </span>
          ...
          <div className="space-y-4 lg:col-span-3">
            ...
            >
              <MapPin
                className="mt-0.5 h-4 w-4 shrink-0 text-[#7F203D]"
                aria-hidden="true"
              />
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href={`tel:${LAWYER_INFO.phone.replace(/\s+/g, '')}`}
                className={`text-sm text-[#F4EFE8]/85 transition-colors hover:text-white ${focusRing}`}
                itemProp="telephone"
              >
               {LAWYER_INFO.phone}
              </a>
        ...
        <div className="flex flex-col items-center justify-between gap-6 pt-10 text-xs text-[#F4EFE8]/70 md:flex-row">
          ...
          <div className="order-1 text-center text-xs md:order-2 md:text-right">
            <span>
              © {new Date().getFullYear()} Emilia Sandobar. Todos los derechos
              reservados.
            </span>
          </div>
