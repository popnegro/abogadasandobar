    ...
    <div id="services-section" className="w-full bg-[#FAF6F0]">
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${ASSETS.heroServices})`,
          }}
          aria-hidden="true"
        />
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl space-y-6">
            ...
            <p className="max-w-3xl text-base font-light leading-relaxed text-white/85 sm:text-lg lg:text-xl">
              Defensa penal, litigación compleja y asesoramiento corporativo
              para personas y organizaciones que necesitan una estrategia
              jurídica rigurosa y una intervención profesional directa.
            </p>
          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-16">
            ...
            <div className="lg:col-span-5">
              <div className="relative overflow-hidden bg-[#302D28]">
                ...
                <img
                  src={ASSETS.serviceLitigacionCompleja}
                  alt="Estrategia jurídica y litigación penal"
                  className="aspect-[4/5] w-full object-cover"
                  loading="lazy"
                />

                <div
                  className="absolute inset-0 bg-gradient-to-t from-[#181614]/50 via-transparent to-transparent"
                  aria-hidden="true"
                />

                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                  <p className="text-xs font-bold uppercase tracking-widest text-[#D9A9B8]">
            ...
            <div className="space-y-6 lg:col-span-7">
              ...
              <h2
                ...
                className="max-w-3xl font-serif text-3xl font-bold leading-[1.1] tracking-tight text-[#302D28] sm:text-4xl lg:text-5xl"
              >
              ...
              <p className="max-w-2xl text-base font-light leading-relaxed text-[#302D28]/80 sm:text-lg">
                Cada asunto requiere comprender el contexto, identificar los
                riesgos y definir una estrategia procesal antes de intervenir.
              </p>

              <p className="max-w-2xl text-base font-light leading-relaxed text-[#302D28]/80 sm:text-lg">
                La práctica profesional combina análisis jurídico, preparación
                probatoria y participación directa en las distintas etapas del
                procedimiento, con especial atención a las causas penales de
                mayor complejidad.
              </p>

              <div className="border-l-2 border-[#7F203D] bg-[#FFF8F2] px-5 py-4 sm:px-6">
                <p className="font-serif text-base font-semibold leading-relaxed text-[#302D28] sm:text-lg">
                  Una estrategia sólida comienza mucho antes de llegar a una
                  audiencia.
                </p>
              </div>
      ...
      <section
        ...
        className="w-full bg-[#FAF6F0] py-16 lg:py-24"
      >
        <div className="mx-auto max-w-7xl space-y-12 px-4 sm:px-6 lg:space-y-16 lg:px-8">
          ...
          <div className="max-w-3xl space-y-4">
            ...
            >
              Un abordaje jurídico especializado
            </h2>

            <p className="text-base font-light leading-relaxed text-[#302D28]/80 sm:text-lg">
              Servicios orientados a la prevención, defensa y resolución de
              contingencias penales y corporativas.
            </p>

          </div>

          {/* ======================================================
              MOBILE SNAP TOUCH / DESKTOP 2-COLUMN GRID
          ======================================================= */}
          <div
            id="services-carousel"
            aria-label="Áreas de práctica jurídica"
            className="
              -mx-4 flex snap-x snap-mandatory gap-4 overflow-x-auto
              px-4 pb-5
              sm:mx-0 sm:grid sm:grid-cols-2 sm:gap-6
              sm:overflow-x-visible sm:px-0 sm:pb-0
              sm:snap-none
            "
          >
            {SERVICES.map((service, index) => (
              <article
                ...
                className="
                  group flex w-[82vw] shrink-0 snap-center
                  flex-col overflow-hidden
                  border border-[#DDD2C5]
                  bg-[#FFF8F2]
              ...
              >
                ...
                <div className="relative aspect-[16/10] shrink-0 overflow-hidden bg-[#302D28] sm:aspect-[16/9] lg:aspect-auto lg:h-auto lg:w-[38%]">
                  ...
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-[#181614]/65 via-transparent to-transparent lg:bg-gradient-to-r lg:from-transparent lg:via-transparent lg:to-[#181614]/20"
                    aria-hidden="true"
                  />

                  {/* Number */}
                  <span
                    className="absolute left-5 top-5 font-serif text-sm font-bold text-white"
                    aria-hidden="true"
                  >
                  ...
                  {/* Featured */}
                  {service.isFeatured && (
                    <span className="absolute right-5 top-5 bg-[#7F203D] px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest text-white">
                      Destacado
                    </span>
                  )}
                ...
                <div className="flex flex-1 flex-col p-6 sm:p-7 lg:p-8">
                  ...
                  {/* Icon */}
                  <div
                    className="mb-5 flex h-10 w-10 items-center justify-center bg-[#7F203D]/10 text-[#7F203D] transition-colors duration-300 group-hover:bg-[#7F203D] group-hover:text-white"
                    aria-hidden="true"
                  >
                    {getServiceIcon(
                      service.iconName,
                  ...
                  <h3 className="font-serif text-xl font-bold leading-snug text-[#302D28] transition-colors group-hover:text-[#7F203D]">
                    {service.title}
                  </h3>

                  <p className="mt-4 text-sm font-light leading-relaxed text-[#302D28]/80">
                    {service.shortDesc}
                  </p>
                  ...
                  <ul className="mt-6 space-y-2.5 border-t border-[#302D28]/10 pt-5">
                    {service.bulletPoints.slice(0, 3).map((point) => (
                      <li
                        key={point}
                        className="flex items-start gap-2 text-xs leading-relaxed text-[#302D28]/75"
                      >
                        <span
                          className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-[#7F203D]"
                          aria-hidden="true"
                        />
                        <span>{point}</span>
                      </li>
                  ...
                  <div className="mt-auto pt-7">
                    ...
                    <button
                      ...
                      className={`group/cta inline-flex w-full items-center justify-between border-t border-[#302D28]/10 pt-4 text-left text-xs font-bold uppercase tracking-wider text-[#7F203D] transition-colors hover:text-[#691931] ${darkFocusRing}`}
                      aria-label={`Consultar sobre ${service.title}`}
                    >
                      <span>Consultar sobre este servicio</span>

                      <ArrowRight
                        className="h-4 w-4 shrink-0 transition-transform group-hover/cta:translate-x-1"
                        aria-hidden="true"
                      />
                    </button>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-8 border border-white/15 bg-white/5 p-7 sm:p-10 lg:flex-row lg:items-center lg:justify-between lg:gap-12 lg:p-12">
            ...
            <div className="max-w-3xl space-y-4">
              ...
              >
                ¿Necesita evaluar una situación jurídica específica?
              </h2>

              <p className="max-w-2xl text-base font-light leading-relaxed text-white/75 sm:text-lg">
                Una primera consulta permite analizar el contexto, identificar
                las cuestiones relevantes y determinar los próximos pasos.
              </p>
            ...
            <button
              ...
              className="
                ...
                focus-visible:ring-[#D9A9B8]
                focus-visible:ring-offset-2
                focus-visible:ring-offset-[#302D28]
                sm:px-8
                sm:text-sm
              "
            >
