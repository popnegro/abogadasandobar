...
const AREAS = [
  { id: 'penal', number: '01', title: 'DERECHO PENAL', description: 'Defensa penal, representación de víctimas y litigación en causas provinciales y federales.', pattern: 'radial-gradient(circle at 18% 25%,rgba(217,169,184,.20),transparent 28%),linear-gradient(135deg,#241D20 0%,#4B2632 48%,#181614 100%)' },
  { id: 'empresas', number: '02', title: 'SOLUCIONES LEGALES A EMPRESAS', description: 'Asesoramiento preventivo, compliance y protección jurídica para empresas y equipos directivos.', pattern: 'radial-gradient(circle at 78% 20%,rgba(217,169,184,.18),transparent 30%),linear-gradient(135deg,#181614 0%,#303033 52%,#4A363A 100%)' },
  { id: 'seguros', number: '03', title: 'REPRESENTACIÓN PENAL Y SEGUROS', description: 'Asistencia jurídica coordinada ante siniestros que requieren análisis penal y gestión jurídica integral.', pattern: 'radial-gradient(circle at 24% 78%,rgba(217,169,184,.18),transparent 28%),linear-gradient(135deg,#211B1A 0%,#3A3330 52%,#5A3D45 100%)' },
