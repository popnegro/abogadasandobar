        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl space-y-6">
            ...
            <p className="max-w-3xl text-base font-light leading-relaxed text-white/85 sm:text-lg lg:text-xl">
              Defensa penal, litigación compleja y asesoramiento corporativo para personas y organizaciones que necesitan una estrategia jurídica rigurosa y una intervención profesional directa en Mendoza.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-16">
            ...
            <div className="space-y-6 lg:col-span-7">
              <p className="ds-eyebrow">Estrategia jurídica</p>
              <h2 id="services-introduction-title" className="ds-section-title max-w-3xl">
                Estrategia jurídica con intervención directa
              </h2>
              <p className="ds-section-lead max-w-2xl">
                Cada asunto requiere comprender el contexto, identificar los riesgos y definir una estrategia procesal antes de intervenir. Si hay una detención, un allanamiento o una citación urgente, el primer paso cambia y la respuesta debe ser inmediata.
              </p>
              <p className="ds-section-lead max-w-2xl">
                La práctica profesional combina análisis jurídico, preparación probatoria y participación directa en las distintas etapas del procedimiento, con especial atención a las causas penales de mayor complejidad y a la defensa corporativa preventiva.
              </p>
      ...
      <section id="services-catalog" aria-labelledby="services-catalog-title" className="w-full bg-[#FAF6F0] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl space-y-12 px-4 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="max-w-3xl space-y-4">
            <p className="ds-eyebrow">Áreas de práctica especializada</p>
            <h2 id="services-catalog-title" className="ds-section-title">Un abordaje jurídico especializado</h2>
            <p className="ds-section-lead">Servicios orientados a la prevención, defensa y resolución de contingencias penales y corporativas.</p>
          </div>

          <div className="space-y-4 lg:hidden">
            {SERVICES.slice(0, 4).map((service, index) => (
              <article key={service.id} id={`service-card-mobile-${service.id}`} className="group ds-card overflow-hidden">
                <div className="relative aspect-[16/10] overflow-hidden bg-[#302D28]">
                  <img src={service.image} alt={service.title} className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" loading={index < 2 ? 'eager' : 'lazy'} decoding="async" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#181614]/65 via-transparent to-transparent" aria-hidden="true" />
                  ...
                  <div className="ds-card-inner p-5 sm:p-6">
                  <div className="mb-4 flex h-10 w-10 items-center justify-center bg-[#7F203D]/10 text-[#7F203D] transition-colors duration-300 group-hover:bg-[#7F203D] group-hover:text-white" aria-hidden="true">
                    {getServiceIcon(service.iconName, 'h-5 w-5 text-[#7F203D] group-hover:text-white')}
                  </div>

                  <h3 className="ds-card-title group-hover:text-[#7F203D]">{service.title}</h3>
                  <p className="mt-3 text-sm font-light leading-relaxed text-[#302D28]/80">{service.shortDesc}</p>

                  <button type="button" onClick={handleNavigateToContact} className={`mt-5 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#7F203D] transition-colors hover:text-[#691931] ${darkFocusRing}`} aria-label={`Consultar sobre ${service.title}`}>
          ...
          <div id="services-carousel" aria-label="Áreas de práctica jurídica" className="hidden -mx-4 gap-4 overflow-x-auto px-4 pb-5 sm:mx-0 sm:grid sm:grid-cols-2 sm:gap-6 sm:overflow-x-visible sm:px-0 sm:pb-0 sm:snap-none lg:grid-cols-2 lg:grid">
            {SERVICES.map((service, index) => (
              <article key={service.id} id={`service-card-${service.id}`} className="group ds-card flex flex-col overflow-hidden lg:min-h-[300px] lg:flex-row">
                <div className="relative aspect-[16/10] shrink-0 overflow-hidden bg-[#302D28] sm:aspect-[16/9] lg:aspect-auto lg:h-auto lg:w-[38%]">
                  <img src={service.image} alt={service.title} className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" loading={index < 4 ? 'eager' : 'lazy'} decoding="async" />
                ...
                <div className="ds-card-inner flex flex-1 flex-col p-6 sm:p-7 lg:p-8">
                  ...
                  <div className="mt-5 grid gap-4 border-t border-[#302D28]/10 pt-5 lg:grid-cols-3">
                    <div className="space-y-2">
                      <span className="block text-[10px] font-bold uppercase tracking-widest text-[#7F203D]">Cuándo se necesita</span>
                      <ul className="space-y-1.5 text-xs leading-relaxed text-[#302D28]/75">
                    ...
                    <div className="space-y-2">
                      <span className="block text-[10px] font-bold uppercase tracking-widest text-[#7F203D]">Qué incluye</span>
                      <ul className="space-y-1.5 text-xs leading-relaxed text-[#302D28]/75">
                    ...
                    <div className="space-y-2">
                      <span className="block text-[10px] font-bold uppercase tracking-widest text-[#7F203D]">Provincia vs federal</span>
                      <p className="text-xs leading-relaxed text-[#302D28]/75">{service.provincialVsFederal}</p>
                    </div>
                  </div>
      ...
      <section id="services-final-cta" aria-labelledby="services-final-cta-title" className="w-full bg-[#302D28] py-16 text-white lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-8 border border-white/15 bg-white/5 p-7 sm:p-10 lg:flex-row lg:items-center lg:justify-between lg:gap-12 lg:p-12">
            <div className="max-w-3xl space-y-4">
              <p className="ds-eyebrow text-[#D9A9B8]">Consulta profesional</p>
              <h2 id="services-final-cta-title" className="font-serif text-3xl font-bold leading-tight text-white sm:text-4xl">¿Necesita evaluar una situación penal o corporativa hoy?</h2>
              <p className="max-w-2xl text-base font-light leading-relaxed text-white/75 sm:text-lg">Una primera consulta permite analizar el contexto, identificar las cuestiones relevantes y determinar los próximos pasos con reserva profesional.</p>
            </div>
            <button type="button" onClick={onRequestConsultation} className="ds-btn-primary group shrink-0 bg-[#7F203D] px-7 py-4 focus-visible:ring-[#D9A9B8] focus-visible:ring-offset-[#302D28] sm:px-8 sm:text-sm">
